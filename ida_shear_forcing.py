# Ida's response timescale to shear forcing
...
best_track = [  # manually extracted from Ida (2009) best tracks
    #('2009-11-04 12:00', 11.4, -81.8, 35),
    ('2009-11-05 00:00', 12.3, -82.8, 55),
    ('2009-11-05 12:00', 12.9, -83.6, 70),
    ('2009-11-06 00:00', 13.6, -83.9, 35),
    ('2009-11-06 12:00', 14.7, -83.9, 30),
    ('2009-11-07 00:00', 16.1, -84.0, 30),
    ('2009-11-07 12:00', 17.7, -84.0, 55),
    ('2009-11-08 00:00', 19.5, -84.5, 70),
    ('2009-11-08 12:00', 20.9, -85.8, 85),
    ('2009-11-09 00:00', 23.0, -86.5, 90),
    ('2009-11-09 12:00', 26.3, -88.3, 60),
    #('2009-11-10 00:00', 28.9, -88.7, 60),  # last tropical entry
]
# 10 data
...
best_track_tropical = best_track[:10]  # drop Sep 20 entry
...
ds = nc.Dataset('/Users/bobo/Documents/GitHub/Y1CyclonesSummerProject/data/ida_surface_V_evolution.nc')  # 28 data sets, contains u10 and v10, 2023-09-06 to 2023-09-19, 00:00 and 12:00
...
#     vws = vws_detrended[:10 - steps] if steps > 0 else vws_detrended     # shear at time T (only taking first 10 timestamps for vws to match vmax)
...
# plt.savefig('/Users/bobo/Documents/GitHub/Y1CyclonesSummerProject/VWS_shear_forcing_plots/Ida_Vmax_vs_VWS_detrended.png')
# plt.show()
...
for idx, dt in enumerate([0, 12, 24, 36, 48]):  # 5 values → axes[0] to axes[4]
    ...
    vws = vws_diff[:9 - steps] if steps > 0 else vws_diff  # vws_diff has 19 values only
...
plt.suptitle("Vmax vs Annulus-mean VWS for Ida (Differenced Data)", fontsize=14)
plt.tight_layout(pad=3.0)
plt.savefig('/Users/bobo/Documents/GitHub/Y1CyclonesSummerProject/VWS_shear_forcing_plots/Ida_Vmax_vs_VWS_differenced.png')
plt.show()